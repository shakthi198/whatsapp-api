...
const Sidebar = ({ darkMode }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 left-0 h-full w-64 shadow-lg flex flex-col p-4 transform transition-transform duration-300 ease-in-out z-40 overflow-y-auto custom-scrollbar ${darkMode ? "bg-gray-900 text-white" : "bg-white text-gray-700"
...
const NavItem = ({ icon, label, path, closeSidebar }) => {
  ...
  return (
    <Link
      ...
      className={`flex items-center p-3 rounded-lg transition duration-300 transform hover:scale-105 hover:shadow-lg ${isActive
  ...
  return (
    <div>
      <button
        ...
        className={`flex justify-between items-center p-3 rounded-lg w-full text-left transition duration-300 transform hover:scale-105 hover:shadow-lg ${isParentActive
          ...
          {subItems.map((item) => {
            ...
            return (
              <Link
                ...
                to={item.path}
                onClick={closeSidebar}
                className={`block p-2 rounded-md text-sm transition ${active
                    ? "bg-blue-500 text-white"
