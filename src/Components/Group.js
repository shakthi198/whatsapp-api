...
export default function GroupMsg() {
  ...
  const handleSelectTemplate = (template) => {
    setMessageContent(template.templateBody || template.content || template.templatename); // Use the correct property from the template
  ...
  return (
    <div className="max-w-6xl mx-auto p-6" style={{ fontFamily: "Montserrat" }}>
      ...
      {/* Form Section */}
      <div className="max-w-6xl mx-auto p-4 bg-white shadow-md mt-1 rounded-lg border border-gray-300">
        ...
        <div className="mt-4">
          ...
          <textarea
            className="w-full p-2 border border-yellow-600 bg-gray-100 rounded-md h-40 cursor-pointer"
            readOnly
