...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost/whatsapp_admin/register.php", {
      method: "POST",
      headers: {
        ...
        if (data.status === "success") {
          ...
          const hasEmptyFields = requiredFields.some(
            (field) =>
              !user[field] ||
              user[field].trim() === "" ||
              user[field].toUpperCase() === "NULL"
          );
          if (hasEmptyFields) setShowReminder(true);
        }
      })
  ...
  const cardsData = useMemo(
    () => ({
      Overview: [
        {
          icon: <MdSupportAgent size={50} color="#0077B6" />,
          title: "Marketing",
          value: cardData.marketing,
        ...
        },
        {
          ...
          value: cardData.userInitiated,
          backgroundColor: "#C8E6C9",
          path: "/dashboard",
        },
        {
          icon: <FiBell size={50} color="#D32F2F" />,
        ...
        {
          icon: <FiSmile size={50} color="#6D28D9" />,
          title: "Total",
        ...
        },
        {
          icon: <MdSupportAgent size={50} color="#0077B6" />,
          title: "Open Ticket",
          value: cardData.openTicket,
          backgroundColor: "#B3E5FC",
          path: "/open-tickets",
        },
        {
          icon: <MdPendingActions size={50} color="#028A0F" />,
          title: "Pending",
        ...
        {
          icon: <FiCheckCircle size={50} color="#D32F2F" />,
          title: "Solved",
          value: cardData.solved,
          backgroundColor: "#FFCDD2",
          path: "/solved-tickets",
        },
        {
          icon: <MdOutlineCancel size={50} color="#FBBF24" />,
          title: "Expired",
          value: cardData.expired,
          backgroundColor: "#FFF3CD",
          path: "/expired-tickets",
        },
      ],
    }),
    [cardData]
